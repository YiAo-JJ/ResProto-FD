...
if __name__ == '__main__':
    ...
    if args.test_level == 'frame':
        ...
        all_labels, all_scores, auroc, ap, eer = trainer.test(use_GRP=args.use_GRP)
    ...
    if args.test_level == 'video':
        video_labels, video_scores,auc_video, ap_video, eer_video = trainer.test_video(use_GRP=args.use_GRP)
